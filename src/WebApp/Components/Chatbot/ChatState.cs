...
public class ChatState
{
        ...
        IChatClient chatClient)
    {
        ...
        Messages = new[]
        {
            new ChatMessage(ChatRole.System, """
                ...
                Your job is to answer customer questions about products in the "Collectible Diecast" catalog.
                "Collectible Diecast" primarily sells collectible scale models of various cars and motorcycles from various manufacturers.
                You try to be concise and only provide longer responses if necessary.
                If someone asks a question about anything other than "Collectible Diecast", its catalog, or their account,
                you refuse to answer, and you instead ask if there's a topic related to "Collectible Diecast" you can assist with.
                """),
    ...
    [Description("Searches the 'Collectible Diecast' catalog for a provided product description")]
