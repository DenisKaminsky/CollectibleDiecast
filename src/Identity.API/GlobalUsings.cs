...
global using CollectibleDiecast.Identity.API;
global using CollectibleDiecast.Identity.API.Configuration;
global using CollectibleDiecast.Identity.API.Data;
global using CollectibleDiecast.Identity.API.Models;
global using CollectibleDiecast.Identity.API.Services;
